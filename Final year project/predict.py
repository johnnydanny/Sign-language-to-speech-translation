...
class Application:
    ...
    def __init__(self):
        ...
        self.video_frame = ctk.CTkFrame(self.root, fg_color="#f0f0f0", corner_radius=10, width=680, height=400)
        self.video_frame.place(x=10, y=50)

        self.other_panel_frame = ctk.CTkFrame(self.root, fg_color="#f0f0f0", corner_radius=10, width=560, height=410)
        self.other_panel_frame.place(x=700, y=50)

        self.char_sentence_frame = ctk.CTkFrame(self.root, fg_color="#f0f0f0", corner_radius=10, width=660, height=150)
        self.char_sentence_frame.place(x=10, y=480)

        self.suggestion_frame = ctk.CTkFrame(self.root, fg_color="#f0f0f0", corner_radius=10, width=700, height=150)
        self.suggestion_frame.place(x=600, y=480)

        # Title
        self.T = ctk.CTkLabel(self.root, text="Sign Language To Speech Conversion",
                              font=("Roboto", 28, "bold"), text_color="#1a73e8")
        self.T.place(x=10, y=10)

        # Video panel
        # self.panel = ctk.CTkLabel(self.video_frame, text="Video Feed", font=("Roboto", 20),
        #                           width=640, height=700, fg_color="#ffffff")
        # Video panel
        self.panel = ctk.CTkLabel(self.video_frame, text="", font=("Roboto", 20), fg_color="#ffffff")
        self.panel.place(relwidth=1, relheight=1, anchor="nw")

        # Other panel (processed feed) with ash background
        self.panel2 = ctk.CTkLabel(self.other_panel_frame, text="", font=("Roboto", 20),
                                   fg_color="#E0E0E0")
        self.panel2.place(relwidth=1, relheight=1, anchor="nw")

        # Character and Sentence
        self.T1 = ctk.CTkLabel(self.char_sentence_frame, text="Character:", font=("Roboto", 20, "bold"),
                               text_color="#202124")
        self.T1.place(x=20, y=20)

        self.panel3 = ctk.CTkLabel(self.char_sentence_frame, width=100, height=40, fg_color="#ffffff", text="")
        self.panel3.place(x=130, y=20)

        self.T3 = ctk.CTkLabel(self.char_sentence_frame, text="Sentence:", font=("Roboto", 20, "bold"),
                               text_color="#202124")
        self.T3.place(x=20, y=100)

        # Increased width for sentence label
        self.panel5 = ctk.CTkLabel(self.char_sentence_frame, width=100, height=40, text="")
        self.panel5.place(x=120, y=100)

        # Suggestions
        self.T4 = ctk.CTkLabel(self.suggestion_frame, text="Suggestions:", text_color="#ea4335",
                               font=("Roboto", 20, "bold"))
        self.T4.place(x=20, y=20)

        # Add buttons for suggestions
        button_width = 120
        button_height = 30
        button_color = "#e8f0fe"
        button_hover_color = "#d2e3fc"
        text_color = "#1a73e8"

        self.b1 = ctk.CTkButton(self.suggestion_frame, text="", width=button_width, height=button_height,
                                fg_color=button_color, hover_color=button_hover_color, text_color=text_color)
        self.b1.place(x=20, y=60)

        self.b2 = ctk.CTkButton(self.suggestion_frame, text="", width=button_width, height=button_height,
                                fg_color=button_color, hover_color=button_hover_color, text_color=text_color)
        self.b2.place(x=180, y=60)

        self.b3 = ctk.CTkButton(self.suggestion_frame, text="", width=button_width, height=button_height,
                                fg_color=button_color, hover_color=button_hover_color, text_color=text_color)
        self.b3.place(x=340, y=60)

        self.b4 = ctk.CTkButton(self.suggestion_frame, text="", width=button_width, height=button_height,
                                fg_color=button_color, hover_color=button_hover_color, text_color=text_color)
        self.b4.place(x=500, y=60)

        # Speak and Clear buttons
        self.speak = ctk.CTkButton(self.suggestion_frame, text="Speak", font=("Roboto", 16), width=100, height=40,
                                   fg_color="#1a73e8", hover_color="#1765cc", text_color="#ffffff",
                                   command=self.speak_fun)
        self.speak.place(x=20, y=100)

        self.clear = ctk.CTkButton(self.suggestion_frame, text="Clear", font=("Roboto", 16), width=100, height=40,
                                   fg_color="#ea4335", hover_color="#d93025", text_color="#ffffff",
                                   command=self.clear_fun)
        self.clear.place(x=180, y=100)
    ...
    def video_loop(self):
        try:
            ...
            # Convert current image to CTkImage
            imgtk = CTkImage(self.current_image, size=(680, 400))
            ...
            if hands:
                ...
                if handz:
                    ...
                    imgtk = CTkImage(self.current_image2, size=(550, 400))
                    self.panel2.imgtk = imgtk
                    self.panel2.configure(image=imgtk)

                    self.panel3.configure(text=self.current_symbol, font=("Courier", 30))

                    # self.panel4.config(text=self.word, font=("Courier", 30))

                    self.b1.configure(text=self.word1, font=("Courier", 20), command=self.action1)
                    self.b2.configure(text=self.word2, font=("Courier", 20), command=self.action2)
                    self.b3.configure(text=self.word3, font=("Courier", 20), command=self.action3)
                    self.b4.configure(text=self.word4, font=("Courier", 20), command=self.action4)

            self.panel5.configure(text=self.str, font=("Courier", 30))
        except Exception:
